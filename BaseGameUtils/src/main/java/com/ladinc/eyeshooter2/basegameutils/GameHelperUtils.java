package com.ladinc.eyeshooter2.basegameutils;
...
class GameHelperUtils {
    ...
    private final static int[] RES_IDS = {
            com.ladinc.eyeshooter2.basegameutils.R.string.gamehelper_unknown_error, com.ladinc.eyeshooter2.basegameutils.R.string.gamehelper_sign_in_failed,
            com.ladinc.eyeshooter2.basegameutils.R.string.gamehelper_app_misconfigured, com.ladinc.eyeshooter2.basegameutils.R.string.gamehelper_license_failed
    };
